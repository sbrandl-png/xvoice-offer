  ...
  <div style="${s.container}">
    <div style="${s.card}">
      <table width="100%" style="border-collapse:collapse"><tr>
        <td><h1 style="${s.h1}">Ihr individuelles Angebot</h1>
          <p style="${s.p}">Stand ${todayIso()} · Netto-Preise zzgl. USt.</p>
        </td>
        <td align="right"><span style="${s.pill}">xVoice UC</span></td>
      </tr></table>
      ...
      ${address ? `<p style="${s.p}">${escapeHtml(address)}</p>` : ""}
