...
function ProductRow({
  ...
  return (
    <div className="grid grid-cols-[minmax(220px,1fr)_100px_140px_120px] items-start gap-4 py-3 border-b last:border-none">
      <div>
...
export default function Page() {
  ...
  const lineItems = useMemo(() => {
    return CATALOG.filter((p) => {
      ...
      return { ...p, quantity: q, total: p.price * q };
    });
  }, [qty, serviceAutoQty]);
  ...
  const offerHtml = useMemo(
    ...
    [customer, salesperson, lineItems, subtotal, vatRate, discountPct]
  );
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      >
        <div className="grid grid-cols-1 gap-2">
          <div className="grid grid-cols-[minmax(220px,1fr)_100px_140px_120px] gap-4 text-xs uppercase text-muted-foreground pb-2 border-b">
            <div>Produkt</div>
            <div>Preis</div>
            <div>Menge</div>
