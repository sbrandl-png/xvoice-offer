...
export default function OrderPage() {
  ...
  // Token aus der URL nur einmal ermitteln (Client-Only)
  const token = useMemo(() => {
    try {
  ...
  // Platzhalter – bei dir gern dynamisch befüllen
  const signer = { name: "", email: "" };
  const accept = true;         // z. B. Checkbox für AGB
  const salesEmail = "";       // optional: zusätzl. Empfänger
    ...
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 py-12">
      <div className="max-w-lg w-full bg-white shadow-md rounded-xl p-8 text-center">
        <img
          ...
          className="mx-auto h-16 mb-6"
        />
        <h1 className="text-2xl font-semibold text-gray-900 mb-3">Bestellung abschließen</h1>
